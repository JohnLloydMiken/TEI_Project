...
### CSD Views
| Login | Dashboard Overview | Individual Checker |
|---|---|---|
| ![Login](docs/screenshots/Login.png) | ![Dashboard Overview](docs/screenshots/Overview.png) | ![Individual Checker](docs/screenshots/Individual-Checker.png) |

| Batch (Paste) | Batch (Upload) | Confirmation Modal |
|---|---|---|
| ![Batch-Paste Checker](docs/screenshots/Batch-Paste-Checker.png) | ![Batch-Upload Checker](docs/screenshots/Batch-Upload-Checker.png) | ![Confirmation Modal](docs/screenshots/Customer-Action.png) |

| Customer List | Export Data |
|---|---|
| ![Customer List](docs/screenshots/Customer-List-All.png) | ![Export Data](docs/screenshots/Export-Data.png) |

### Admin Views
| Manage Users | User Modal | Upload Master List |
|---|---|---|
| ![Manage Users](docs/screenshots/Manage-User.png) | ![User Modal](docs/screenshots/User-Modal.png) | ![Upload Master List](docs/screenshots/Upload-MastertList.png) |
